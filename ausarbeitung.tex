...
\usepackage[toc,page]{appendix} % Für den Anhang
...
%done - Irinas und Jonas' comments einarbeiten 

%done - Abbildung 1 erläutern, vor allem die Farben

%done - Diskussion: "Ergebnisse" Singularisieren 

%done - Bilder aus Anhang referenzieren

%- Bei Abbildung 2 erläutern, wofür die Briefe und Akteure z.B. stehen und Schuljahre 

%done - Meister Schüler Modell: Literatur

%- Ergebnis-Nummern: Sollen die lieber hinter oder vor den Punkt?
%- Tabelle überarbeiten und referenzieren

%- Zweite Seite des Anmeldungsformulars ergänzen

%- Inhaltsverzeichnis bis level 3?

%- Anhangsverzeichnis

%done - Bezeichnungen im Anhang

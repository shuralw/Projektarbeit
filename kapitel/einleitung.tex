...
\begin{itemize}
    ...
    \item Wie sollte so ein Fragebogen aussehen? (LF4)% (Ergebnisteil)
...
Die Leitfragen 1-3 werden zunächst im Theorieteil behandelt, welcher die Begrifflichkeiten definiert und vergleichbare Literatur heranzieht. Im Ergebnisteil der Studie werden durch die kurze Skizzierung des Fragebogens und der Zusammenfassung der Erkenntnisse der Studie Leitfragen 4 und 5 beantwortet. Im Diskussionsteil werden die Ergebnisse interpretiert und die Leitfragen gebündelt beantwort. Durch diese Vorgehensweise soll im Diskussionsteil geklärt werden, ob\textit{Schüler Online} den Anwender ermächtigt, die Software effektiv und zufriedenstellend benutzen zu können (Leitfrage 6).

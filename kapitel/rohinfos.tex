%Bei einem Report (documentclass \glqq scrreprt\grqq{}) oder einem Buch(\glqq scrbook\grqq{})  ist das 
...
%=> Ggf. eine Annahme darlegen: Schüler sitzen dem Schulpersonal gegenüber wenn sie sich anmelden, die Sekretärin füllt die Daten aus die der Schüler ihr nennt.
...
%Interview: Welche verschiedenen Szenarien kommen vor, wenn sich ein Schüler bei Ihnen anmelden möchte - wie muss man sich das vorstellen?
%Beispiel - (nicht erwähnen!!): \glqq Ein Schüler sitzt vor mir und ich sitze am Rechner, ich trage seine Daten ein.
%Soll Hypothese bzw. Bias belegen: Eine Sekretariatsmitarbeiterin führt die Anmeldung im Beisein und Diallog mit dem Schüler durch.
...
%Verwenden Sie die Software Schüler Online für Anmeldungen?
%Wie häufig?
%Welche Schwierigkeiten bereitet Ihnen die Software \textit{Schüler Online 1.0} (Ist eine Folgefrage, die nur Personen die bereits 1.0 verwenden gestellt werden kann)
...
%    Ziel: 
%    Das Szenario \glqq Mit Betrieb anmelden\grqq{} existiert nicht nur für die Sek II Anmeldung.
% 
...
% 			- Feldtest 
% 			- Wie lief das \glqq Intro\grqq{} bei der Beobachtung ab? Was hat der Beobachter den Beobachteten vorher gesagt und erläutert?
% 		- Filmen?
...
%Diskussion: Mein Schreiberling: Muss er ungelernt oder gelernt sein? Vergleich mit Literatur
%Hawthorne Effekt
%
...
%gab es beispielsweise für ein Programmierproblem mehrere alternative Bibliotheken, geben Sie an, warum Sie eine bestimmte auswählen.
